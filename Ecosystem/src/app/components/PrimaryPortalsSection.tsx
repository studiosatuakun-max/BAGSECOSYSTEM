  ...
  return (
    <section ref={sectionRef} className="py-16 px-6 bg-background" id="portals">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Two Portal Cards (Frosted Glass Panels) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">

          {/* Industrial Portal — B2B */}
          <div className="reveal-up-hidden stagger-2 portal-card rounded-[2.2rem] overflow-hidden glass-panel group cursor-pointer hover:-translate-y-2 transition-all duration-500 hover:shadow-[0_25px_60px_-10px_rgba(30,58,95,0.25)]">
            {/* Image Header */}
            <div className="relative h-56 overflow-hidden">
              ...
              {/* Badge */}
              <div className="absolute top-4 left-4 flex items-center gap-2 bg-industrial/90 backdrop-blur-md text-primary-foreground rounded-full px-3.5 py-1.5 shadow-md">
            ...
            <div className="p-7 relative z-10">
              <div className="flex items-start justify-between gap-3 mb-3">
                <div>
                  <h3 className="font-extrabold text-foreground" style={{ fontSize: '1.3rem' }}>
                    Industrial Portal
                  </h3>
                ...
                <div className="icon-container bg-industrial-light flex-shrink-0 shadow-sm group-hover:scale-110 transition-transform duration-300">
          ...
          {/* Horeca Portal — B2C */}
          <div className="reveal-up-hidden stagger-3 portal-card rounded-[2.2rem] overflow-hidden glass-panel group cursor-pointer hover:-translate-y-2 transition-all duration-500 hover:shadow-[0_25px_60px_-10px_rgba(217,119,6,0.25)]">
            {/* Image Header */}
            <div className="relative h-56 overflow-hidden">
              <AppImage
              ...
              {/* Badge */}
              <div className="absolute top-4 left-4 flex items-center gap-2 rounded-full px-3.5 py-1.5 backdrop-blur-md shadow-md" style={{ backgroundColor: 'rgba(180,83,9,0.9)', color: '#fff' }}>
