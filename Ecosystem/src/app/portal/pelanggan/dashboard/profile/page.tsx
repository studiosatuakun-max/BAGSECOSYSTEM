  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="flex-1 px-4 py-6 space-y-2">
        ...
        <div className="pt-6">
          <Link href="/portal/pelanggan" className="flex items-center justify-center gap-2 w-full p-4 text-error font-bold rounded-2xl border border-error-bg bg-error-bg hover:bg-error/10 transition-colors">
            <LogOut size={20} />
            Sign Out
          </Link>
        </div>
