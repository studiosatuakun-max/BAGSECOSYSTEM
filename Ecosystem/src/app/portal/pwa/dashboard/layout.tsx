...
const navItems = [
  { id: 'nav-dashboard', label: 'Dashboard', href: '/portal/pwa/dashboard', icon: HomeIcon },
  { id: 'nav-safety', label: 'Safety', href: '/portal/pwa/dashboard/safety', icon: ShieldIcon },
  { id: 'nav-scan', label: 'Scan', href: '/portal/pwa/dashboard/scan', icon: ScanIcon },
  { id: 'nav-stops', label: 'Stops', href: '/portal/pwa/dashboard/stops', icon: MapPinIcon },
];
...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  const getActiveRoute = () => {
    if (pathname === '/portal/pwa/dashboard') return '/portal/pwa/dashboard';
    if (pathname?.includes('/safety')) return '/portal/pwa/dashboard/safety';
    if (pathname?.includes('/scan')) return '/portal/pwa/dashboard/scan';
    if (pathname?.includes('/stops') || pathname?.includes('/route')) return '/portal/pwa/dashboard/stops';
    return '/portal/pwa/dashboard';
  };
