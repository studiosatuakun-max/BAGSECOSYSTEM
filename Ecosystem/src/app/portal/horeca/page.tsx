    ...
    <div className="min-h-screen bg-slate-50/80 font-sans relative flex flex-col">
      ...
      <div className="flex-1 w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 py-6 space-y-6">
        ...
        <div className="mt-8 pt-4 border-t border-slate-200/60 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400 gap-2 font-medium">
          <div className="flex items-center gap-2">
            <span className="font-extrabold text-slate-700 dark:text-slate-300">Baskara Executive Engine v2.5.0 (CNG Commercial Benchmark)</span>
            <span>·</span>
            <span>PT Baskara Asri Ghas Executive Console</span>
          </div>
          <div>
            <span>Empowering East Java Horeca &amp; Commercial Sector with Clean Compressed Natural Gas (CNG)</span>
          </div>
        </div>
